...
public class RunModel {
    ...
    public static BufferedImage getFasterScaledInstance(BufferedImage img, int targetWidth, int targetHeight, boolean progressiveBilinear) throws IOException {
        ...
        ImageIO.write(ret, "png", new File("./temp/test_resized2.png"));
        return ret;
    }
    private static TFloat32 preprocess(BufferedImage sourceImage, int imageHeight, int imageWidth, int imageChannels) throws IOException {
        ...
        //scaledImage=getFasterScaledInstance(sourceImage,imageHeight,imageWidth,true);
